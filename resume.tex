...
\begin{resume}
    ...
    Mail: \href{mailto:alex@aub.dev}{alex@aub.dev} \hfill GitHub: \url{https://github.com/a-lxe}\\
    Phone: +1 (978) 894-6108 \hfill LinkedIn: \url{https://linkedin.com/in/a-lxe}
    ...
    \begin{position}
        ...
        Extracurriculars: TA for Discrete Structures (2017), Upperclassman Tutor (2016)
    \end{position}
    ...
    \begin{position}
        ...
        \begin{list2}
            \item Developed ML models for quickly predicting the traffic and solar potential of a model city.
            \item Developed a Unity/C\# application for real-time visualization of said model city.
        \end{list2}
    \end{position}
    ...
    \textit{Versed-} Rust; C; Lisp \\
    \textbf{WebDev}:
    Node.js; React+Gatsby; HTML/CSS \\
    \textbf{Tools}:
    Unity; Mathematica; Photoshop; Blender (CAD); ROOT (Statistics) \\
    \textbf{Misc}:
